...
export class LandProtection {
  ...
  static init() {
    // Combined interval - runs every 40 ticks (was 4 separate intervals)
    system.runInterval(() => {
      ...
      for (let i = start; i < end; i++) {
        ...
        if (claim) {
          ...
          // Mob cleanup for this player's area
      ...
      // Cache cleanup (every ~60s worth of ticks)
    ...
    }, 40) // Was 5, 20, 20, 60000 - now single 40 tick interval
